...
/-- The coordinate matrix carrying the displayed frame conic to the standard model. -/
def q5FrameMatrix : Matrix (Fin 3) (Fin 3) (ZMod 5) :=
  ![![1, 2, 3], ![0, 1, 3], ![3, 2, 4]]

/-- The displayed quadratic `X²+Y²+Z²+XY+XZ+YZ`. -/
...
`GF(5)`, including the displayed frame conic. -/

...
`RelativeConicArcs.Q11BrianchonClassification` records the same two statements,
specialized to order eleven, and derives each from a terminal exported here; the
terminals prove them at their own quantifier range from the definitions in this
library.
